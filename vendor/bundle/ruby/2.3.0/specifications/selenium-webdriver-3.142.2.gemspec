# -*- encoding: utf-8 -*-
# stub: selenium-webdriver 3.142.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<childprocess>, ["< 2.0", ">= 0.5"])
      s.add_runtime_dependency(%q<rubyzip>, [">= 1.2.2", "~> 1.2"])
      ...
      s.add_dependency(%q<childprocess>, ["< 2.0", ">= 0.5"])
      s.add_dependency(%q<rubyzip>, [">= 1.2.2", "~> 1.2"])
